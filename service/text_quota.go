...
func composeTieredTextQuota(relayInfo *relaycommon.RelayInfo, summary textQuotaSummary, tieredQuota int, tieredResult *billingexpr.TieredResult) int {
	...
	if tieredResult != nil {
		if snap := relayInfo.TieredBillingSnapshot; snap != nil {
			return common.QuotaFromFloat(decimal.NewFromFloat(tieredResult.ActualQuotaBeforeGroup).
	...
	return tieredQuota + common.QuotaFromFloat(summary.ToolCallSurchargeQuota.Round(0).InexactFloat64())
}
...
func calculateTextQuotaSummary(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage) textQuotaSummary {
	...
	if !relayInfo.PriceData.UsePrice {
		...
		summary.Quota = common.QuotaFromFloat(quotaCalculateDecimal.Round(0).InexactFloat64())
	} else {
